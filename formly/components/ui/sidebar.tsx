  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "w-[--sidebar-width] bg-transparent transition-[width] duration-200 ease-linear z-50 absolute",
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-7 w-7 pb-1", className)}
      onClick={(event) => {
        onClick?.(event);
        toggleSidebar();
      }}
...
>(({ className, ...props }, ref) => {
  return (
    <div
      ref={ref}
      data-sidebar="header"
      className={cn("flex flex-col gap-2 pl-4 p-2", className)}
      {...props}
    />
  );
});
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        rounded-md p-0 text-sidebar-foreground outline-none ring-sidebar-ring transition-transform
...
const sidebarMenuButtonVariants = cva(
  `peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm
   outline-none ring-sidebar-ring transition-[width,height,padding] hover:bg-sidebar-accent hover:text-sidebar-accent-foreground 
