...
type fontSizeType = "small" | "medium" | "large" | "x-large" | "2x-large" | "4x-large";

type fontWeightType = "normal" | "lighter" | "bold" | "bolder";
...
const paragraphValidateSchema = z.object({
  ...
  fontSize: z.enum(["small", "medium", "large", "x-large", "2x-large", "4x-large"]).default("small"),
  fontWeight: z.enum(["normal", "lighter", "bold", "bolder"]).default("normal"),
});
...
function ParagraphPropertiesComponent({
  ...
  const form = useForm<ParagraphPropertiesSchema>({
    resolver: zodResolver(paragraphValidateSchema) as any,
    mode: "onBlur",
    defaultValues: {
